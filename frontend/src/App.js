...
import "./App.scss";
import Shoes from "./views/shoespage/Shoes";
...
function App() {
  ...
  //======================================================================
  // UseEffect used to handle user, meal, and shoes data functions
  //======================================================================
  useEffect(() => {
    //===============================
    ...
    const fetchUserData = async () => {
      ...
      if (data) {
        ...
        const response = await fetch(
          process.env.REACT_APP_SERVER_URL + "/users/verifytoken",
          settings
        );
    ...
    const fetchShoesData = async () => {
      const response = await fetch(process.env.REACT_APP_SERVER_URL + "/shoes");
      const result = await response.json();
      try {
        if (response.ok) {
          setShoes(result);
  ...
  // This is used to handle the token in order to sign out Automatically after one hour
